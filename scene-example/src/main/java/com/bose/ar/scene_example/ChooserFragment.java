...
//  BoseWearable
//
//  Created by Tambet Ingo on 11/20/2018.
...
public class ChooserFragment extends Fragment {
    ...
    interface Listener {
        ...
        void onSimulatedDeviceSelected(@NonNull SensorType sensorType);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable final Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(b -> onSearchClicked());

        final Button simulatedDeviceButton = view.findViewById(R.id.simulatedDeviceButton);
        simulatedDeviceButton.setOnClickListener(b -> onSimulatedDeviceClicked());
    ...
    private void onDeviceSelected(@NonNull final String deviceAddress) {
        ...
        if (activity instanceof Listener) {
            ...
            listener.onDeviceSelected(deviceAddress, selectedSensor());
        }
    }
    ...
    private void onSimulatedDeviceClicked() {
        ...
        if (activity instanceof Listener) {
            final Listener listener = (Listener) activity;
            listener.onSimulatedDeviceSelected(selectedSensor());
        }
    }
